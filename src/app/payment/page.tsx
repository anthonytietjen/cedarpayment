...
export default function Home() {
  ...
  const { isSubmittingPayment } = useSubmitPayment();
  ...
  const handleSubmitBillingConfirmation = async () => {
    // Simulate network api call with a useSubmitPayment hook
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex-1 w-full md:max-w-[576px] items-center text-sm bg-white rounded-none md:rounded-[32px] md:mt-7">
        ...
        <div className="flex flex-col items-center border-t border-borderGray">
          <div className="w-full max-w-[376px] flex-col1 pb-8">
            <div
              className="flex items-center h-[81px] gap-4 text-[20px]"
              role="banner"
            >
